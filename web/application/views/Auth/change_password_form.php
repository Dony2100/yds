...
<div class="card-body">
    <div class="form-group">      
        <label for="exampleInputPassword1"><?php echo form_label('Old Password', $old_password['id']); ?></label>
    ...
    <div class="form-group">      
        <label for="exampleInputPassword1"><?php echo form_label('Confirm New Password', $confirm_new_password['id']); ?></label>
