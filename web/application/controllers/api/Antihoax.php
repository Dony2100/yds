 ...
 * GET api/antihoax/search/[method]/[value]/[key] -> where [author, title, source_link, content, tags, status, all]
...
class Antihoax extends REST_Controller
{
    ...
    public function search_post()
    {
        ...
        $allow_method = array('author', 'title', 'source_link', 'content', 'tags', 'status', 'all');
        if(empty($key)){
            $this->response('Access failed', 200);
