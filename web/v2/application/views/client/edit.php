...
<?php echo form_open('client/edit/'.$client['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="domain" value="<?php echo ($this->input->post('domain') ? $this->input->post('domain') : $client['domain']); ?>" class="form-control" id="domain" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="ip" value="<?php echo ($this->input->post('ip') ? $this->input->post('ip') : $client['ip']); ?>" class="form-control" id="ip" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="key" value="" class="form-control" id="key" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="quota" value="<?php echo ($this->input->post('quota') ? $this->input->post('quota') : $client['quota']); ?>" class="form-control" id="quota" />
 	...
 	<div class="form-group">
		...
		<div class="col-md-8">
                    <?php   echo form_dropdown( array('name'=>'status','id'=>'status','class'=>'form-control'), 
                                                array(''=>'Select Status','active'=>'Active','pending'=>'Pending','suspend'=>'Suspend'), 
                                                ($this->input->post('status') ? $this->input->post('status') : $client['status']))?>
